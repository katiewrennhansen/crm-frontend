                ...
                <div className="form-content-section">
                    ...
                    <div className="form-content-section">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="street_name" defaultValue={asset.adescription1}></input>
                        </div>
                        <div className="form-group row">
                            <div>
                                <label htmlFor="city">City<span className="required">*</span></label>
                                <input type="text" name="city" defaultValue={asset.adescription2}></input>
                            </div>
                            <div>
                                <label htmlFor="state">State<span className="required">*</span></label>
                                <input type="text" name="state" defaultValue={asset.adescription3}></input>
                            </div>
                        </div>
                        <div className="form-group row">
                            <div>
                                <label htmlFor="zip_code">Zip Code<span className="required">*</span></label>
                                <input type="text" name="zip_code" defaultValue={asset.adescription4}></input>
                            </div>
                            <div>
                                <label htmlFor="country">Country<span className="required">*</span></label>
                                <input type="text" name="country"defaultValue={asset.adescription5}></input>
                            </div>
                        </div>
                    </div>
